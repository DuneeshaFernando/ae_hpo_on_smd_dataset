...
cluster_files = ['machine-2-5.csv', 'machine-2-7.csv']
mod_name = "c0"
target_configs = {'NUM_LAYERS': 3, 'WINDOW_SIZE': 23, 'HIDDEN_SIZE': 35, 'BATCH_SIZE': 209, 'LEARNING_RATE': 4.507664256956887e-05}
